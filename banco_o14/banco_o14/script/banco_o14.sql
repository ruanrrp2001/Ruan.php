...
INSERT INTO gerente(nome_bairro) VALUES ('Asa sul'), ('Asa norte'), ('Lago sul'), ('Lago norte');

INSERT INTO usuario(nome_usuario,bairro_usuario) VALUES ('oto',2), ('anna',4), ('gorety',1), ('odety',1);

INSERT INTO gerente(nome_gerente,bairro_gerente) VALUES ('gilson Americanas',1), ('MAuricio ambev',3), ('silvio da IBM',1), ('Davidson do BB',2), ('Ruan da caixa',1);
